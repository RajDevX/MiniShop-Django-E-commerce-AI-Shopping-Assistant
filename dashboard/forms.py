...
from .models import Category, Product, UserProfile, banner, navbar, services
...
class UserSettingsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Ensure the username field remains editable in the UI.
        ...
        self.fields["username"].help_text = "Must be unique. After changing, click “Save Details”."
